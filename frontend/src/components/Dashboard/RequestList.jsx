...
import { Clock, User, MessageSquare, ArrowRight, Smartphone } from 'lucide-react'
    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-600">
          All requests have been addressed or there are no new incidents.
        </p>
      </div>
    )
  }
          ...
          >
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2 space-y-2">
                      <div className="flex items-center text-sm">
                        <span className="text-gray-700 font-medium mr-2">ID:</span>
              ...
              <div className="lg:w-48 flex justify-end lg:justify-center">
                <Button
                  onClick={() => onApprove(request.chatId)}
                  loading={isApproving}
                  ...
                  size="lg"
                >
                  {isApproving ? 'Approving...' : 'Approve & Chat'}
                </Button>
              </div>
            </div>
          </div>
